        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            ...
            <input
              ...
              required
              className={`w-full px-3 sm:px-4 py-2 sm:py-2.5 border rounded-md sm:rounded-lg shadow-sm text-sm sm:text-base focus:outline-none focus:ring-2 transition-colors ${
                isPasswordMismatch 
